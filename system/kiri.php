...
elseif ($_GET['module']=='semuaproduk'){
	...
	<tr class='data'>
	<th class='data' width='30px'><span style='color:black;'>No</span></th>
	<th class='data'><span style='color:black;'>Kode Produk</span></th>
	<th class='data'><span style='color:black;'>Nama Produk</span></th>
	<th class='data'><span style='color:black;'>Harga Jual</span></th>
	<th class='data'><span style='color:black;'>Action</span></th>
	</tr>";
...
elseif ($_GET['module']=='keranjangbelanja'){
	...
	echo "<h3>Halaman Transaksi </h3><br>
	<div class='h_line'></div>
	...
	<thead>
	<tr class='data'>
	<th class='data'><span style='color:black;'>Kode</span></th>
	<th class='data'><span style='color:black;'>Nama Produk</span></th>
	<th class='data'><span style='color:black;'>Jumlah</span></th>
	<th class='data'><span style='color:black;'>Harga</span></th>
	<th class='data' width='90px'><span style='color:black;'>Sub Total</span></th>
	<th class='data'></th>
	</tr>
	</thead>";
	$no=1;
	...
	<tr>
	<td colspan='4' style='text-align:right;'><b style='font-size:24px; color:black;'>Total Belanja :</b></td>
	...
	<tr>
	<td colspan='4' style='text-align:right;'><b style='font-size:24px; color:black;'>Bayar :</b></td>
	...
	<tr>
	<td colspan='4' style='text-align:right;'><b style='font-size:24px; color:black;'>Kembali :</b></td>
	...
	echo "<h3>Data Produk <span style='float:right'></span> <span style='float:right'><a style='float:right;' target='_BALNK' href='print-dataproduk.php?'>Cetak Data Produk</a></span></h3>
	<span style='float:right;'>
	<form action='' method='POST' style='margin-right:22px'>
	Cari Produk : <input type='text' name='kata' style='width:200px; margin-bottom:3px;' placeholder='Input Kode Produk'/>
	<input type='submit' name='cari' value='cari'>
	</form>
	</span><br/>
	<div class='h_line'></div>";
	...
	if ($_GET['custt']=='update'){
		...
		<th class='data'><input type='text' name='a' value='$m[kode_produk]' placeholder='Input Kode Produk'></th>
		<th class='data'><input type='text' name='b' value='$m[nama_produk]' placeholder='Input Nama Produk'></th>
		<th class='data'><input type='text' name='c' value='$m[harga_pokok]' placeholder='Input Harga Pokok'></th>
		<th class='data'><input type='text' name='d' value='$m[harga]' placeholder='Input Harga Jual'></th>
	...
	if (isset($_POST['da'])){
		mysqli_query($koneksi, "UPDATE produk SET kode_produk = '$_POST[a]',
			nama_produk = '$_POST[b]',
			harga_pokok = '$_POST[c]',
			harga = '$_POST[d]',
			harga_grosir = '$_POST[e]'
	...
	if (isset($_GET['delete'])){
		mysqli_query($koneksi, "DELETE FROM produk where id_produk='$_GET[delete]'");
	...
	while($r=mysqli_fetch_array($tampil)){
		...
		if ($_SESSION['leveluser']=='Admin'){
			echo "<a href='media.php?module=semuacostumer&custt=update&id=$r[id_produk]'><img src='../mos-css/img/detail.png'></a>&nbsp; 
			<a href='media.php?module=semuacostumer&delete=$r[id_produk]' onclick=\"return confirm(‘Yakin Hapus?’);\" style='color:red; font-weight:bold; '>X</a>&nbsp; ";
		} 
		echo "</center></td>
		</tr>";
		$no++;
...
elseif ($_GET['module']=='statuspembelian'){
	...
	echo "<table class='data'>
	<tr class='data'>
	<th class='data' width='70px'><span style='color:black;'>No Faktur</span></th>
	<th class='data'><span style='color:black;'>Total Belanja</span></th>";
	if ($_SESSION['leveluser']=='Admin'){ echo "<th class='data'><span style='color:black;'>Nama Kasir</span></th>"; }
	echo "<th class='data'><span style='color:black;'>Tanggal</span></th>
	<th class='data'><span style='color:black;'>Jam</span></th>
	<th class='data'><span style='color:black;'>Action</span></th>
	</tr>"; 
	...
	if ($cekkeranjang == 0){
	  ...
	  if ($_GET['module']=='laporan'){
	  	...
	  	while($r=mysqli_fetch_array($tampil)){
	  		...
	  		<a href=media.php?module=hapuslaporan&id=$r[id_orders]&stat=$r[status]>Hapus</a>
	  		</td>
	  		</tr>";
	  		$no++;
	  	}
     ...
     // rumus untuk menghitung subtotal dan total	
	  ...
	  }elseif ($_GET['module']=='hapuslaporan'){
	  	mysqli_query($koneksi, "DELETE FROM orders WHERE id_orders='$_GET[id]'");
	  	echo "<script>window.alert('Data Berhasil Dihapus');
	  	window.location=('laporan.html')</script>";
